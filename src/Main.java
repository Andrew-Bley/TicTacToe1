...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            for (int m = 1; m <= 9; ++m) {
                ...
                do {
                    rowMove = SafeInputs.getRangedInt(in, turn + "'s move. Enter your Row: ", 1, 3);
                    rowMove = rowMove -1;
                    colMove = SafeInputs.getRangedInt(in, turn + "'s move. Enter your Column: ", 1, 3);
                    colMove = colMove - 1;
            ...
            Continue = SafeInputs.getYNConfirm(in, "Do You Want to Play Again? [Y/N]");
            System.out.println();
            if(Continue){
                System.out.print("X is now O and O is now X");
                System.out.println();
            }
        }while (Continue);
    ...
    private static boolean isValidMove(int row, int col) {
        ...
        if (board[row][col].equals(" - ")) {
            ...
            System.out.print("Invlaid move, You can't an already taken spot ");
        }
        return valmove;
    }
